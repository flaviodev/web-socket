...
public class Client {
	...
	public void sendMessage(StompSession stompSession, Order order) {

		stompSession.send("/app/order", order);
	}

	public static void sendMessage(Order order) throws InterruptedException, ExecutionException {
		OrderSessionHandler handler = new OrderSessionHandler();
		...
		orderClient.sendMessage(stompSession, order);
...
class OrderSessionHandler extends StompSessionHandlerAdapter {
